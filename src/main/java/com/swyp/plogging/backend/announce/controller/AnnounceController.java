...
public class AnnounceController {
    ...
    @PostMapping
    public ApiResponse<AnnounceResponse> createAnnounce(@RequestParam String title, @RequestParam String content) {
        AnnounceResponse announce = announceService.createAnnounce(title, content);
